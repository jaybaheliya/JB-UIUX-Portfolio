var PageTransitions = function (a) {
    ...
    function f(b, c) {
        ...
        var c, e, f, h, m = b.data("animation").toString();
        if (-1 != m.indexOf("-")) {
            var p = m.split("-");
        ...
        if (s = c, q != s) {
            ...
            v.scrollTop(0), u.addClass(f).on(n, function () {
                u.off(n), k = !0, l && (g(r, v, u), k = !1)
            }), v.addClass(e).on(n, function () {
                v.off(n), l = !0, k && (g(r, v, u), l = !1, j = !1)
            })
        } else j = !1;
        o || g(u, v)
    }
